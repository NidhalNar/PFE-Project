...
$requette = "SELECT * FROM conge WHERE (etat='Validée' AND email='".$_SESSION['email']."' )";
...
$requette1 = "SELECT * FROM conge WHERE (etat='Refusée' AND email='".$_SESSION['email']."' )";
...
$requette2 = "SELECT * FROM perdiem WHERE (etat='Validée' AND email='".$_SESSION['email']."' )";
...
$requette3 = "SELECT * FROM perdiem WHERE (etat='Refusée' AND email='".$_SESSION['email']."' )";
...
$requette4 = "SELECT * FROM deplacement WHERE (etat='Validée' AND email='".$_SESSION['email']."' )";
...
$requette5 = "SELECT * FROM deplacement WHERE (etat='Refusée' AND email='".$_SESSION['email']."' )";
...
$requette6 = "SELECT * FROM avance WHERE (etat='Validée' AND email='".$_SESSION['email']."' )";
...
$requette7 = "SELECT * FROM avance WHERE (etat='Refusée' AND email='".$_SESSION['email']."' )";
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link active"  href="history.php" aria-expanded="false" aria-controls="tables">
