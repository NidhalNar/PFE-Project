              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" id="profile-tab"  href="avance.php" role="tab" aria-selected="false">Demandes</a>
                    </li>
                    ...
                    <div class="row">
                      <div class="col-lg-12 d-flex flex-column">
                        ...
                        <?php
                            ...
                            if( isset($_GET['ajouteavance']) &&   $_GET['ajouteavance'] == "ok"  )      {
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <form  action="gestion/ajouteavance.php"  method="POST">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control form-select " name="paiement" required >
                                            <option value="" selected disabled hidden>Choisir votre methode de paiement</option>
                                            <option></option>
