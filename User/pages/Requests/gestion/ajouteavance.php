...
$conn = connect();
$responsable=getresemailavance();


$requette="INSERT INTO avance (nom,prenom,email,date,montant,paiement,responsable,etat) VALUES ('$nom','$prenom','$email','$date','$montant','$paiement','$responsable','$etat')" ;
    ...
    require("../../../../mail2/PHPMailer-master/src/SMTP.php");
      ...
      $mail->Body = '<h4>Connectez-vous à votre compte pour voir la nouvelle demande.</h4>';
       ...
       if(!$mail->Send()) {
          ...
          header('location:../avance.php?ajouteavance=ok');
       }
