...
<head>
  ...
  <title>Demande de Perdiem</title>
  <!-- plugins:css -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="request">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item active"> <a class="nav-link" href="perdiem.php">Demande de Perdiem</a></li>
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" id="profile-tab"  href="perdiem.php" role="tab" aria-selected="false">Demandes</a>
                    </li>
                    ...
                    <div class="row">
                      <div class="col-lg-12 d-flex flex-column">
                        ...
                        <?php
                              ...
                              if( isset($_GET['ajouteperdiem']) &&   $_GET['ajouteperdiem'] == "ok"  )      {
                        ...
                        <div class="row flex-grow">
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="card-title">Demande De Perdiem</h4>
                                ...
                                <form  action="gestion/ajouteperdiem.php"  method="POST">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" >Date mission<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="date" class="form-control" name="datemission"   required>
                                        </div>
                                      </div>
                                    </div>
                                   <div class="col-md-6">
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Montant <span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Pays<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Ville<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">CIN ou Passeport<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                          <input type="number" class="form-control"  min="0" name="cinpass" required>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Détails mission</label>
                                        <div class="col-sm-9">
