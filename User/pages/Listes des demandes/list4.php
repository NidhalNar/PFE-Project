...
$requette = "SELECT * FROM avance WHERE etat='Saisie'";

$resultat =$conn->query($requette);

$avances = $resultat->fetchAll();
        ...
        <ul class="nav">
          ...
          elseif($_SESSION['role'] =="Responsable de Deplacement") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="list3.php">Liste de  déplacement</a></li>
          ...
          elseif($_SESSION['role'] =="Responsable Avance") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item active"> <a class="nav-link" href="list4.php">Liste d\'Avance </a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="list">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="list3.php">Liste  deplacement</a></li>
                <li class="nav-item active"> <a class="nav-link" href="list4.php"> Liste d'Avance </a></li>
              </ul>
            </div>
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link  active" id="more-tab"  href="../Listes des demandes/list4.php" role="tab"  aria-selected="false">Liste</a>
                    </li>
                    <li class="nav-item">
                      ...
                      <div class="col-lg-12 d-flex flex-column">
                        ...
                        <!-- <div class="row flex-grow">
                          ...
                          <?php
                                    ...
                                    if( isset($_GET['valideravance']) &&   $_GET['valideravance'] == "ok"  )      {
                                      ...
                                      <b> Demande Validée avec Succès </b>
                                        ...
                                        if( isset($_GET['refuseravance']) &&   $_GET['refuseravance'] == "ok"  )      {
                              ...
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                   ...
                                   <p class="card-subtitle card-subtitle-dash">Liste De Demande D'avance</p>
                                  </div>
                                  ...
                                  <table id="example" class="table  table-hover display nowrap  border" style="width:100%">
                                    ...
                                    foreach($avances as $avance){
                                      $i++;
                                       ...
                                       <td>  <a href="valider/valideravance.php?idavance='.$avance['id'].'" class="btn btn-success btn-lg rounded text-light">Valider</a>
                                         <a href="refuser/refuseravance.php?idravance='.$avance['id'].'" class="btn btn-danger btn-lg rounded text-light">Refuser</a></td>
