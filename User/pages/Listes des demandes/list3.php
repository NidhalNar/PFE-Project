...
$requette = "SELECT * FROM deplacement WHERE etat='Saisie'";

$resultat =$conn->query($requette);

$deplacements = $resultat->fetchAll();
...
<head>
  ...
  <title>Liste de Deplacement</title>
  <!-- plugins:css -->
        ...
        <ul class="nav">
          ...
          <?php if($_SESSION['role'] =="Responsable de Conge") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="list1.php">Liste de Conge</a></li>
           ...
           elseif($_SESSION['role'] =="Responsable de Perdiem") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="list2.php">Liste de Perdiem</a></li>
          ...
          elseif($_SESSION['role'] =="Responsable de Deplacement") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item active"> <a class="nav-link" href="list3.php">Liste de  déplacement</a></li>
          ...
          elseif($_SESSION['role'] =="Responsable Avance") {
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="list">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item "> <a class="nav-link" href="list4.php">Liste d\'Avance </a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="list">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item "> <a class="nav-link" href="list1.php">Liste  Conge</a></li>
                <li class="nav-item"> <a class="nav-link" href="list2.php"> Liste  Perdiem</a></li>
                <li class="nav-item active"> <a class="nav-link" href="list3.php">Liste  deplacement</a></li>
                <li class="nav-item"> <a class="nav-link" href="list4.php"> Liste d'Avance </a></li>
              </ul>
            </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="request">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../Requests/conge.php">Conge</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="../Mails/mails.php" aria-expanded="false" aria-controls="ui-basic">
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active " id="more-tab"  href="list3.php" role="tab"  aria-selected="false">Liste</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row">
                      <div class="col-lg-12 d-flex flex-column">
                        ...
                        <?php
                                ...
                                if( isset($_GET['validerdeplacement']) &&   $_GET['validerdeplacement'] == "ok"  )      {
                                  ...
                                  <b> Demande Validée avec Succès </b>
                                    ...
                                    if( isset($_GET['refuserdeplacement']) &&   $_GET['refuserdeplacement'] == "ok"  )      {
                              ...
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                   ...
                                   <p class="card-subtitle card-subtitle-dash">Liste De Demande De Déplacement</p>
                                  </div>
                                  ...
                                  <table id="example" class="table  table-hover display nowrap  border " style="width:100%">
                                    ...
                                    foreach($deplacements as $deplacement){
                                      $i++;
                                       ...
                                       <td>'.$deplacement['montant'].'</td>
                                       <td>'.$deplacement['client'].'</td>
                                       <td>'.$deplacement['projet'].'</td>
                                     
                                       <td><div class="badge badge-opacity-warning ">'.$deplacement['etat'].'</div></td>
                                       <td>  <a href="valider/validerdeplacement.php?iddeplacement='.$deplacement['id'].'" class="btn btn-success btn-lg rounded text-light">Valider</a>
                                         <a href="refuser/refuserdeplacement.php?idrdeplacement='.$deplacement['id'].'" class="btn btn-danger btn-lg rounded text-light">Refuser</a></td>
