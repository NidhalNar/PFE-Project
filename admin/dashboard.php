...
$requette2 = "SELECT * FROM perdiem WHERE etat='saisie'";
...
$requette3 = "SELECT * FROM deplacement WHERE etat='saisie'";
...
$requette4 = "SELECT * FROM avance WHERE etat='saisie'";
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item"  href="pages/admin/deconnexion.php"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
            </div>
          </li>
        </ul>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/Users list/List.php">List</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Users list/Add.php">Add</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="request">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/Requests/conge.php">Congé</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/Requests/perdiem.php"> Perdiem</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="pages/Mails/mails.php" aria-expanded="false" aria-controls="charts">
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active ps-0" id="home-tab"  href="dashboard.php" role="tab" aria-controls="overview" aria-selected="true">Dashboard</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link " id="more-tab"  href="pages/Users list/List.php" role="tab" aria-selected="false">Users</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="profile-tab"  href="pages/Requests/conge.php" role="tab" aria-selected="false">Requests</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="#demographics" role="tab" aria-selected="false">Mails</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link border-0" id="more-tab"  href="pages/History/history.php" role="tab" aria-selected="false">History</a>
                    </li>
                  </ul>
                            ...
                            <div class="card  bg-gradient-info  card-rounded">
                              <div class="card-body pb-0">
                                ...
                                <div class="row">
                                  ...
                                  $requette5 = "SELECT count(*) FROM conge WHERE etat='Validée'";
                                  
                                  $resultat5 =$conn->query($requette5);
                                  
                                  $rows1 = $resultat5->fetchColumn();

                                  $requette6 = "SELECT count(*) FROM perdiem WHERE etat='Validée'";
                                  
                                  $resultat6 =$conn->query($requette6);
                                  
                                  $rows2 = $resultat6->fetchColumn();

                                  $requette7 = "SELECT count(*) FROM deplacement WHERE etat='Validée'";
                                  
                                  $resultat7 =$conn->query($requette7);
                                  
                                  $rows3 = $resultat7->fetchColumn();

                                  $requette8 = "SELECT count(*) FROM avance WHERE etat='Validée'";
                            ...
                            <div class="card  bg-gradient-danger card-rounded">
                              <div class="card-body pb-0">
                                ...
                                <div class="row">
                                  ...
                                  $requette5 = "SELECT count(*) FROM conge WHERE etat='Refusée'";
                                  
                                  $resultat5 =$conn->query($requette5);
                                  
                                  $rows1 = $resultat5->fetchColumn();

                                  $requette6 = "SELECT count(*) FROM perdiem WHERE etat='Refusée'";
                                  
                                  $resultat6 =$conn->query($requette6);
                                  
                                  $rows2 = $resultat6->fetchColumn();

                                  $requette7 = "SELECT count(*) FROM deplacement WHERE etat='Refusée'";
                                  
                                  $resultat7 =$conn->query($requette7);
                                  
                                  $rows3 = $resultat7->fetchColumn();

                                  $requette8 = "SELECT count(*) FROM avance WHERE etat='Refusée'";
                        ...
                        <div class="row flex-grow">
                          <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                            <div class="card  bg-gradient-warning card-rounded">
                              <div class="card-body pb-0">
                                <h4 class="card-title card-title-dash text-white mb-4">Demandes En Attente De Validation</h4>
                                <div class="row">
                                  <div class="col-sm-4">
                                    <p class="status-summary-ight-white mb-1">Demandes En Attente</p>
                                    <h2 class="text-light">
                                  ...
                                  $requette5 = "SELECT count(*) FROM conge WHERE etat='saisie'";
                                  
                                  $resultat5 =$conn->query($requette5);
                                  
                                  $rows1 = $resultat5->fetchColumn();

                                  $requette6 = "SELECT count(*) FROM perdiem WHERE etat='saisie'";
                                  
                                  $resultat6 =$conn->query($requette6);
                                  
                                  $rows2 = $resultat6->fetchColumn();

                                  $requette7 = "SELECT count(*) FROM deplacement WHERE etat='saisie'";
                                  
                                  $resultat7 =$conn->query($requette7);
                                  
                                  $rows3 = $resultat7->fetchColumn();

                                  $requette8 = "SELECT count(*) FROM avance WHERE etat='saisie'";
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  ...
                                  <div>
                                    <button class="btn btn-success btn-lg text-white mb-0 me-0" type="button" onclick="location.href='pages/users list/add.php'"><i class="mdi mdi-account-plus" ></i>Add new member</button>
                                  </div>
                                </div>
