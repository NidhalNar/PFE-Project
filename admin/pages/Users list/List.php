          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item active"> <a class="nav-link" href="List.php">List</a></li>
                    ...
                    <div class="row">
                      <div class="col-lg-12 d-flex flex-column">
                        ...
                        if( isset($_GET['ajout']) &&   $_GET['ajout'] == "ok"  )      {
                           ...
                           <b> Utilisateur ajoutée avec Succès </b>
                        ...
                        ?>
                           <?php
                              ...
                              if( isset($_GET['delete']) &&   $_GET['delete'] == "ok"  )      {
                                  ...
                                  <b> Utilisateur supprimée avec Succès </b>
                              ...
                              ?>
                                  ...
                                  if( isset($_GET['modif']) &&   $_GET['modif'] == "ok"  )      {
                                     ...
                                     <b> Utilisateur modifée avec Succès </b>
                              ...
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  ...
                                  <div>
                                   ...
                                   <p class="card-subtitle card-subtitle-dash">Employers List</p>
                                  </div>
                                  
                                  <div>
                                    <button class="btn btn-primary btn-lg text-white mb-0 me-0" onclick="location.href='add.php'" type="button"><i class="mdi mdi-account-plus"></i>Add new member</button>
                                  </div>
                                </div>
                                ...
                                <table class="table  table-hover display nowrap border " style="width:100%" id="myTable">
                                    ...
                                    <?php foreach($users as $user){
                                      ...
                                      <td><div class="badge rounded-pill bg-secondary ">Vide</div></td>
                                      
                                      <td>  <a  class="btn btn-success btn-lg rounded text-light" data-bs-toggle="modal" data-bs-target="#exampleModal'.$user['id'].'">  Edit</a>
                                        <a href="gestion/delete.php?iduser='.$user['id'].'" class="btn btn-danger btn-lg rounded text-light">Delete</a></td>
                                    ...
                                    ?>
                                      ...
                                      <!-- <tr>
                                        ...
                                        <td> 
                                          <span>
                                          <a href="Modify.php" class="btn btn-success btn-lg rounded text-light">Edit</a>
                                          <a href="#" class="btn btn-danger btn-lg rounded text-light">Delete</a>
                                        </span>
                                      </td>
                                      </tr>
                                      <tr>
                                        ...
                                        <td><div class="badge badge-opacity-warning ">en cours</div></td>
                                        <td> <a href="Modify.php" class="btn btn-success btn-lg text-light">Edit</a>
                                          <a href="#" class="btn btn-danger btn-lg rounded text-light">Delete</a></td>
                                      ...
                                      <tr>
                                       ...
                                       Responsable
                                        ...
                                        <td> <a href="Modify.php" class="btn btn-success btn-lg rounded text-light">Edit</a>
                                          <a href="#" class="btn btn-danger btn-lg rounded text-light">Delete</a></td>
                                      ...
                                      <tr>
                                        ...
                                        <td><div class="badge badge-opacity-success">Validée</div></td>
                                        <td> <a href="Modify.php" class="btn btn-success btn-lg rounded text-light">Edit</a>
                                          <a href="#" class="btn btn-danger btn-lg rounded text-light">Delete</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form action="gestion/modifier.php" method="POST">

                <input type="hidden" value="<?php echo $user['id'];?>" name="idemp">
                    ...
                    <div class="form-group ">
                      <label><b>Number</b></label>
                            ...
                            <input type="number" name="mobile" class="form-control" value="<?php echo $user['mobile'];?>">
                  ...
                  <select class="form-select" name="role" >
                      ...
                      <?php   if (($user['role']=="Employee") ||($user['role']=="employee") ||($user['role']=="Employée") ||($user['role']=="employée")) {
                        print'
                      ...
                      ';
                    }  elseif (($user['role']=="Responsable de Conge") ||($user['role']=="Responsable de Congé") ||($user['role']=="responsable de conge") ||($user['role']=="responsable de congé")){
                      print'
                      <option  disabled >Select your option</option>
                      <option  >Employee</option>
                      <option selected>Responsable de Conge</option>
                      <option>Responsable de Perdiem</option>
                      <option>Responsable de Deplacement</option>
                      <option>Responsable Avance</option>';

                    }elseif (($user['role']=="Responsable de Perdiem") ||($user['role']=="responsable de perdiem") ){
                      print'
                      <option  disabled >Select your option</option>
                      <option  >Employee</option>
                      <option >Responsable de Conge</option>
                      <option selected>Responsable de Perdiem</option>
                      <option>Responsable de Deplacement</option>
                      <option>Responsable Avance</option>';
                    }elseif (($user['role']=="Responsable de Déplacement") ||($user['role']=="Responsable de Deplacement") ||($user['role']=="Responsable de déplacement") ||($user['role']=="responsable de deplacement")){
                      print'
                      <option  disabled >Select your option</option>
                      <option  >Employee</option>
                      <option >Responsable de Conge</option>
                      <option>Responsable de Perdiem</option>
                      <option selected>Responsable de Deplacement</option>
                      <option>Responsable Avance</option>';
                    }else {
                      print'
                      <option  disabled >Select your option</option>
                      ...
                      <option>Responsable de Perdiem</option>
                      <option >Responsable de Deplacement</option>
                      <option selected>Responsable Avance</option>';
                    }
